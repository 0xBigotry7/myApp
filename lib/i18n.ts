...
export const translations = {
  en: {
    ...
    addItem: "Add Item",
    editItem: "Edit Item",
    unorganizedItems: "Unorganized Items",
    itemsNotInLuggage: "Items not yet organized into luggage",
    dragItemsToOrganize: "Drag items to luggage or drag out to unorganize",
    name: "Name",
    type: "Type",
    color: "Color",
  ...
  zh: {
    ...
    addItem: "添加物品",
    editItem: "编辑物品",
    unorganizedItems: "未整理物品",
    itemsNotInLuggage: "尚未整理到行李中的物品",
    dragItemsToOrganize: "拖动物品到行李或拖出以取消整理",
    name: "名称",
    type: "类型",
    color: "颜色",
    weightLimit: "重量限制",
